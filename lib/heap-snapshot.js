...
var createHeapSnapshot = function(stream, events) {
  return new Promise((resolve, reject) => {
    ...
    HeapSnapshotWorker.JSHeapSnapshot.prototype.__calculateFlags = HeapSnapshotWorker.JSHeapSnapshot.prototype.calculateFlags;
    HeapSnapshotWorker.JSHeapSnapshot.prototype.calculateFlags = function(...args) {
      try {
        return this.__calculateFlags(...args);
      } catch (e) {
        console.error(e);
      }
    };
